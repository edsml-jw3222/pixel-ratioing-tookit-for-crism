...
def get_spectrum(hdr_path, pix_coor, model, scaler, ROI=None, window_size=50, num_bland=3):
    ...
    Notes:
    ------
    This function requires the presence of a trained machine learning model (a Random Forest classifier) 
    and a fitted scaler saved as 'random_forest_5.sav' and 'scaler_5.pkl' respectively in the current 
    working directory. These are used for the bland pixel detection.
    """
